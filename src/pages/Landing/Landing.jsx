      ...
      >
        ...
        <div className={style.about} id='about'>
          <div className={style.container1}>
            <img src="https://res.cloudinary.com/dowhfu3fj/image/upload/v1668575898/recipes/Dise%C3%B1o_sin_t%C3%ADtulo_8_cifgue.png" alt='' className={style.image1} />
            <div className={style.col - 2}>
              <h2>About</h2>
              <span className={style.line}></span>
              <p>"The restaurant that takes the best of international gastronomy, the fusion of these flavors, techniques, ingredients and experiences allow us to offer the best dishes to our customers, was founded in 2018 and continues to be the best option to taste any recipe international"</p>
              <p></p>
              <a href='#sec3'>
